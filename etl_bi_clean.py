...
def main(src: str = "source_bruit_1000_final.xlsx", out_dir: str = "clean"):
    ...
    # Corriger les inversions début/fin
    ...
    # Si stage entreprise manquant → entreprise
    ...
    # ========= Agrégation =========
    agg_dict_year = {
        "nom":"first", "prenom":"first", "date_naissance":"first", "annee":"first",
        ...
        "date_embauche":"max", "stage_entreprise":"first",
        "stage_pays":"first", "stage_debut":"min", "stage_fin":"max",
    }
    ...
    dq = {
        ...
        "dates_vides": {c: int((clean[c] == "").sum()) for c in ["date_naissance","date_embauche","stage_debut","stage_fin"]},
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Nettoyage source → CSV/XLSX")
